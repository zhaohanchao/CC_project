...
normalurl = 'https://www.qiushibaike.com/imgrank/page/%d/'


for pagenumber in (1,5):
    newurl = format(normalurl%pagenumber)

    picture_url = requests.get(url=newurl,headers=UA).text
# <div class="thumb">
...
# </div>
    ...
    leading = "正在下载第{}页".format(pagenumber)
    print(leading)
    for src in img_list:
        src = 'https:' + src
